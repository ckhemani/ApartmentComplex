...
public class Main {
    public static void main(String[] args) {
        ...
        OneBedroomApartment aptOneBedroom1 = new OneBedroomApartment("Green Village","hut1",101,0,600,1,true);
        int aptNum1 = aptOneBedroom1.getAptNumber();

        int rentofHut1 = aptOneBedroom1.rent(aptOneBedroom1.getIsGolfFacing());
